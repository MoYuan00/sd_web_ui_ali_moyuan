            ...
            <el-row>
                <div class="textarea">
                    ...
                    <div style="position: absolute; bottom: 8px; right: 8px;">
                        <button class="button font-key pointer gen_button" @click="onClick">
                            生成渲染
                        </button>
                    </div>
                    <!-- ParamsPlane按钮 -->
...
.gen_button:first-child::before,
.gen_button:last-child::before {
...
.gen_button:first-child:hover {
    /* background: linear-gradient(90deg, #00d6f7, #002fff, #0000ff, #002fff, #0073f7); */
    background: linear-gradient(90deg right, #009fff, #0077ff, #002fff, #0000ff, #001aff, #0077ff);
    background-size: 400%;
}

.gen_button:last-child:hover {
    background: linear-gradient(90deg right, #009fff, #0077ff, #002fff, #0000ff, #001aff, #0077ff);
    background-size: 400%;
}

.gen_button:first-child:hover:before,
.gen_button:last-child:hover:before {
    opacity: 1;
    z-index: -1;
}
...
.gen_button:hover {
    z-index: 3;
    background: linear-gradient(to right, #009fff, #0077ff, #002fff, #0000ff, #001aff, #0077ff, #009fff);
